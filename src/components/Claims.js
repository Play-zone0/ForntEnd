...
//  const [newClaim, setNewClaim] = useState({ policy_id: '', amount_claimed: '', status: '' });
//  const [editingId, setEditingId] = useState(null);
//  const [editingData, setEditingData] = useState({ policy_id: '', amount_claimed: '', status: '' });
//
//  useEffect(() => {
//    fetchClaims();
//  }, []);
...
//    e.preventDefault();
//    try {
//      await api.post('/claim/', newClaim);
//      setNewClaim({ policy_id: '', amount_claimed: '', status: '' });
//      fetchClaims();
//    } catch (error) {
//      console.error(error);
...
//    try {
//      await api.put(`/claim/${id}`, { id, ...editingData });
//      setEditingId(null);
//      fetchClaims();
//    } catch (error) {
//      console.error(error);
